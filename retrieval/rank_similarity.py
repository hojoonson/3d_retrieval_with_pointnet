...
locationsim_valid=float(1)
sizesim_valid=float(1)
...
#for i in range(1):
    ...
    f = open("3D_Retrieval_Result.txt", 'a+')
    ...
    for j in range(len(samplelist)):
        ...
        if model_id !=model_id_c:
            ...
            if totalsim>similarity_all:
                ...
                mostsim_model_all=mostsim_model_all+[[model_id_c,totalsim,lemmasim*lemmasim_valid,locationsim*locationsim_valid,sizesim*sizesim_valid,semanticsim*semanticsim_valid,namesim*namesim_valid]]
                valid=1
                ...
                if len(mostsim_model_all)<50:
                    for index in range(len(mostsim_model_all)):
                        ...
                        if mostsim_model_all[-1-index][1]<=totalsim:
                            ...
                            mostsim_model_all[-1-index]=[model_id_c,totalsim,lemmasim*lemmasim_valid,locationsim*locationsim_valid,sizesim*sizesim_valid,semanticsim*semanticsim_valid,namesim*namesim_valid]
                    ...
                    for index in range(50):
                        if len(mostsim_model_all)==50:
                            if mostsim_model_all[-1-index][1]<=totalsim:
                                ...
                                break
            if valid==0:
                mostsim_model_all.insert(0,[model_id_c,totalsim,lemmasim*lemmasim_valid,locationsim*locationsim_valid,sizesim*sizesim_valid,semanticsim*semanticsim_valid,namesim*namesim_valid])
            if len(mostsim_model_all)>=51:
                mostsim_model_all.pop(0)
