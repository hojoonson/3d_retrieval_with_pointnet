...
TRAINING_FILE_LIST = os.path.join(hdf5_data_dir, 'train_partseg_hdf5_file_list.txt')
TESTING_FILE_LIST = os.path.join(hdf5_data_dir, 'val_partseg_hdf5_file_list.txt')
    ...
    with tf.Graph().as_default():
        ...
        def eval_one_epoch(epoch_num):
            ...
            for cat_idx in range(NUM_CATEGORIES):
                if total_seen_per_cat[cat_idx] > 0 and all_obj_cats[cat_idx][0]=="Airplane":
